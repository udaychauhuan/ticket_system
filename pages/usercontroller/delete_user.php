...
<div class="main-work-pace">
    <div class="conatainer w-50 m-auto ">
        <h1 class="text-center p-4">DELETE USER</h1>
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            <table class="table">
                ...
                <tbody>
                    <?php
                    $query = "SELECT id,name,email,phone from user_table where id = $last";
                    $conn =  new Connection;
                    ...
                    ?>
                            <tr>
                                ...
                                <td style='display:flex;'>
                                    ...
                                    <button type="submit" name="delete_user" class="btn btn-danger "><a href="" style="text-decoration:none; color:white;" class="text-center fs-6"><i class="fa fa-trash-o" aria-hidden="true"></i></button>
                                </td>
                            </tr>
                </tbody>
            </table>
